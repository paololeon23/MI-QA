/** Exportación Excel filtrado — Palta MP (MPCP) */

import { getExportOrdenJs, getExportTextColsExcel } from "./palta-mp.config.js";
import { parseFlexibleNumber, parseExcelDateISO, valorCelda } from "./palta-mp.validation.js";
...
export function writePaltaWorkbook(filename, sheetName, wsData) {
