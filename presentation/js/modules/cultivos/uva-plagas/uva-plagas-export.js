/** Exportación Excel — Plagas Uva (orden legacy EXPORT_ORDEN) */
...
export function writePlagasErrorsExport({ rows, headers, config }) {
  ...
  window.XLSX.writeFile(wb, `Plagas_Uva_ErroresResaltados_${stamp}.xlsx`, { cellStyles: true });
  return true;
}
